 ...
 * to reset, calculate and print.
 *
 * @note	This could be optimised to only having x_o & x_p
 * but would need to refactor the calculations points.
 *
 * @note	*_o means the original value (The ones from file).
 ...
 *
 * @param file_in	File name passed through parameter.
...
/**
 * @brief	Calculate a spacing tha fits into one quartet for the model
 * length.
 *
